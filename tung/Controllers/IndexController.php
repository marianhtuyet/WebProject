...
//                if (file_exists("../public/assets/img/".$newfilename))
//                {
...
//                else
//                {
//                    move_uploaded_file($_FILES["file"]["tmp_name"], "../public/assets/img/" . $newfilename);
...
//SELECT max(id_type) from products group by id_product having id_product='acer_1'
