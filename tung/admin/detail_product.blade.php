        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div id="product" class="box">
                    <h1>Sửa sản phẩm</h1>
                    <hr>
                    <form action="{{route('update_detail_product',[$product->id])}}" enctype="multipart/form-data"  method="post">
                        {{----}}
                        {{ csrf_field() }}
                        <div class="row" >
                            <div class="col-md-12">
                                <div>
                                    ...
                                    <input id="nameproduct" name="nameproduct" type="text" value="{{$product->name}}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div>
                                    ...
                                    <input id="quantity" name="quantity" type="number" class="form-control" value="{{$product->quantity}}" min="1" max="10000">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4">
                                <div>
                                    <label for="price">Giá</label>
                                    <input id="price" name="price" type="number" class="form-control" min="1000000" max="10000000000" value={{$product->cost}}
                                           step="10000">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4">
                                <div>
                                    <label for="discount">Giá khuyến mãi</label>
                                    <input id="discount" name="discount" type="number" class="form-control" min="1000000" max="10000000000" step="10000" value={{$product->discount}}>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="describe">Mô tả</label>
                                    <textarea id="describe" name="describe" class="form-control ckeditor" rows="10" >{{$product->description}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12 text-center">
                                <button id="submit" name="submit" type="submit" value="Submit" class="btn btn-primary">
                                    <i class="fa fa-save	"></i>Sửa sản phẩm
