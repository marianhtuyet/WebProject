        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div id="product" class="box">
                    <h1>Thêm sản phẩm</h1>
                    <hr>
                    <form action="{{route('admin.uploadImages')}}" enctype="multipart/form-data"  method="post">
                        {{----}}
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div>
                                    ...
                                    <select id="select-nho" name="select-nho" class="form-control select-nho">
                                        <option>-- Chọn --</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div>
                                    ...
                                    <input id="quantity" name="quantity" type="number" class="form-control" min="1" max="10000">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4">
                                <div>
                                    <label for="price">Giá</label>
                                    <input id="price" name="price" type="number" class="form-control" min="1000000" max="10000000000"
                                           step="10000">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4">
                                <div>
                                    ...
                                    <input id="discount" name="discount" type="number" class="form-control" min="1000000" max="10000000000" step="10000">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
