            ...
            <div class="col-lg-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li aria-current="page" class="breadcrumb-item active">Dell</li>
                    </ol>
                </nav>
            </div>
            @include('layout.menu')
                                ...
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front"><a href="{{route('category.detail', [$value->id])}}"><img
                                                        ...
                                                        alt="{{$value->id_product}}_{{$key+1}}" class="img-fluid"></a>
                                            <!--                                            --><?php //echo '<script>alert('.($key+1).')</script>';?>
                                        </div>
