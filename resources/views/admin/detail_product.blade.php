        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div id="product" class="box">
                    <h1>Sửa sản phẩm</h1>
                    <hr>
                    <form action="{{route('update_detail_product',[$product->id])}}" enctype="multipart/form-data"
                          method="post">
                        {{----}}
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                                <div>
                                    ...
                                    <input id="nameproduct" name="nameproduct" type="text" value="{{$product->name}}"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div>
                                    ...
                                    <input id="price" name="price" type="number" class="form-control" min="1000000"
                                           max="10000000000" value={{$product->cost}}
                                            step="10000">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4">
                                <div>
                                    ...
                                    <input id="discount" name="discount" type="number" class="form-control"
                                           min="1000000" max="10000000000" step="10000" value={{$product->discount}}>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="describe">Mô tả</label>
                                    <textarea id="describe" name="describe" class="form-control ckeditor"
